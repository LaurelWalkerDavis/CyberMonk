...
/****** OBTAIN ACCOUNT INFORMATION FROM MONKS.TXT FILE *******/
$fileName = 'monks.txt';
...
?>
		<div class= content-container>
			<p>
				...
				<a href="Signup.php"><span id="link">Sign up</span></a> or
				<a href="Login.php"><span id="link">Log in</span></a>to get started!
			</p>
		</div>
<?php
}
